    ...
    <div className={isPageScrolling ? "nav active" : "nav"}>
      <div className="container">
        ...
        <div className="side-menu">
          <ul className={isHamburgerOpen ? "nav-list active" : "nav-list"}>
            ...
            <Link className="nav-link" href="open-source" prefetch={false}>
              OpenSource
            </Link>
        ...
        <div className="hamburger" onClick={handleHamburger}>
          <span
            className={isHamburgerOpen ? "span span1 active" : "span span1"}
          />
          <span
            className={isHamburgerOpen ? "span span2 active" : "span span2"}
          />
        </div>
